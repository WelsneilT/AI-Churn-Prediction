...
SECRET_KEY = "django-insecure-ih6+hs5k$#ob909h^kqya&9s@n=^wfhe^8=5b63%r43n*g9^yr"
...
TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [],
        'APP_DIRS': True,  # Điều này cho phép Django tự động tìm template trong thư mục templates của mỗi app
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug',
                'django.template.context_processors.request',
